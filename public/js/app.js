...
$(function () {
	...
	if (location.pathname.indexOf('/account/dashboard') != -1) {
		var vue = new Vue({
			...
			methods: {
				addHobby: function addHobby(hobby) {
					var el = event.target;
					var self = this;
	...
	if (location.pathname.indexOf('/account/profile') != -1) {
		...
		var vue = new Vue({
			...
			methods: {
				...
				updateWechat: function updateWechat() {
					var self = this;
...
Component.options.__file = "C:\\wamp64\\www\\dsite\\dating\\resources\\assets\\js\\components\\Example.vue"
