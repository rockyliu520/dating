<div class="col-md-2 left-feild">
	...
	<div class="be-vidget">
		...
		<div class="tags_block clearfix">
			<ul>
				<li><a data-filter=".Australian" class="filter">Australian Capital Territory</a></li>
				<li><a data-filter=".New" class="filter">New South Wales</a></li>
				<li><a data-filter=".Northern" class="filter">Northern Territory</a></li>
				<li><a data-filter=".Queensland" class="filter">Queensland</a></li>
				<li><a data-filter=".South" class="filter">South Australia</a></li>
				<li><a data-filter=".Tasmania" class="filter">Tasmania</a></li>
				<li><a data-filter=".Victoria" class="filter">Victoria</a></li>
				<li><a data-filter=".Western" class="filter">Western Australia</a></li>
			</ul>
		</div>
	</div>
	<!-- <div class="be-vidget">
