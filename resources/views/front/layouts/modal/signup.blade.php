<form class="popup-input-search r_signup_form">
	...
	<div class="col-md-6 be-date-block noPaddingLeft">
	...
	<div class="col-md-6 be-date-block noPaddingRight">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 noPadding">
			<span class="large-popup-text">
				我希望找
			</span>
		...
		<div class="be-custom-select-block">
			<select class="be-custom-select" name="sex" required="required" v-model="registerLookfor">
				<option value="-1" disabled selected="selected">
					性别
				</option>
				<option value="male">男</option>	
	...
	<div class="col-md-12 be-date-block noPadding">
		...
		<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 noPaddingLeft">
		...
		<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 noPaddingRight">
			<div class="be-custom-select-block">
	...
	<div class="col-md-12 for-signin noPadding">
		<button class="be-popup-sign-button btn-block" type="button" v-on:click="signup()">现在注册</button>
	</div>
</form>